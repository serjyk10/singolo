...
const CONTACTS_BTN = document.querySelector(".contacts-form__button");
...
CONTACTS_BTN.addEventListener("click", event => {
  let name = document.querySelector(".contacts-form__name");
  let email = document.querySelector(".contacts-form__email");

  if (name.checkValidity() && email.checkValidity()) {
    MODAL.classList.add("modal-on");
    let subject = document.querySelector(".contacts-form__subject").value;
    subject = subject ? subject : "Subject is empty";
    let describe = document.querySelector(".contacts-form__textarea").value;
    describe = describe ? describe : "Describe is empty";

    document.querySelector(".contacts-modal__subject").textContent =
      "Subject:" + " " + subject;
    document.querySelector(".contacts-modal__describe").textContent =
